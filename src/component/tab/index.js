      ...
      <>{
        ...
        ?<div className="tab">
            <ul>
                ...
                <li data-tab={`${tab6}`} className={`tab5 tabItem ${hideTab6} ${inactive}`}>{tabs6}<TabIcon /></li>
                <li data-tab={`${tab7}`} className={`tab5 tabItem ${hideTab7} ${inactive}`}>{tabs7}<TabIcon /></li>
            </ul>
        </div>
        :<div className="tab">
            <ul>
                ...
                <li data-tab={`${tab6}`} className={`tab5 color3 ${hideTab6} ${inactive}`}>{tabs6}</li>
                <li data-tab={`${tab7}`} className={`tab5 color1 ${hideTab7} ${inactive}`}>{tabs7}</li>
            </ul>
