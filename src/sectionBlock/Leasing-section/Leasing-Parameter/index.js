            ...
            <div className = "investor-add">
                ...
                <form className='leasingParameterForm' action="/Projects" method='POST' onSubmit={handleSubmit}>
                    <div className="leasingParameter-body">
                        ...
                        <ul>
                            <Select label={`Form of calculation`} name={`Form_of_calculation`} value={Form_of_calculation} placeholder={`Select`} onChange={onChange} value1={`Form_of_calculation-1`} value2={`Form_of_calculation-2`} value3={`Form_of_calculation-3`} value4={`Form_of_calculation-4`} hideValue5={`dn`}/>
                            <Select label={`Data type`} name={`Data_type`} value={Data_type} placeholder={`Select`} onChange={onChange} value1={`Data_type-1`} value2={`Data_type-2`} value3={`Data_type-3`} value4={`Data_type-4`} hideValue5={`dn`}/>
                        </ul>
                        <ul>
                            <Select label={`Format`} name={`Format`} value={Format} placeholder={`Select`} onChange={onChange} value1={`Format-1`} value2={`Format-2`} value3={`Format-3`} value4={`Format-4`} hideValue5={`dn`}/>
                        </ul>
                    </div>
