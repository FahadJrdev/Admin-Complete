              ...
              <div className="sidebar-wrapper">
                <div className="sidebar-component">
                  <ul className="header-menu">
                    ...
                    <Link className={`header-menu-item ${getActiveColor('/Configuration')} ${getActiveColor('/Leasing')}`} to='/Configuration'><Configuration /><p>{language.navBar.Configuration}</p></Link>
