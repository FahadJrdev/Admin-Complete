        ...
        ?<>
          <div className="responsiveConfigDetail">
            ...
            }
            {
              ...
              <main className='main configuration'>
                <div className="configure">
                  <GeneralTab itemClass={`gtab1`} item1={`General parameters`} item2={`Access key management`} item3={`Bank file configuration `} item4={`Access to functionalities`} item5={`Audit weblog`} link1={`#`} link2={`#`} link3={`#`} link4={`#`} link5={`#`} />    
                </div>
              </main>
            </>
              :<></>
            }
            {
              ...
              <main className='main configuration'>
                <div className="configure">
                  <GeneralTab itemClass={`gtab2`} item1={`BackEnd users configuration`} item2={`Users profile configuration`} item3={`Parameterization people`} hideItem4={`dn`} hideItem5={`dn`} link1={`#`} link2={`#`} link3={`#`} link4={`#`} link5={`#`} />    
                </div>
              </main>
            </>
              :<></>
            }
            {
              ...
              <main className='main configuration'>
                <div className="configure">
                  <GeneralTab itemClass={`gtab3`} item1={`Contract management`} item2={`Contract management debt/ leasing`} item3={`Management of investment contracts to projects`} item4={`Management of investment contracts to investors`} item5={`Debt contract collection management`} link1={`#`} link2={`/Leasing`} link3={`#`} link4={`#`} link5={`#`} />    
                </div>
              </main>
            </>
              :<></>
